...
const Skills = () => {
  return (
    <div className='bg-black text-white'>
      <div className='min-h-screen max-w-5x mx-auto px-10 lg:px-20 py-4 md:py-28 lg:py-44 flex flex-col justify-center text-4xl md:text-6xl lg:text-7xl tracking-tight font-semibold'>
          <div className='leading-[1.15]'>
            ...
            <span className={`${s.skillText} mt-[200px] text-[30px]  lg:text-[50px] text-center inline-block after:content-['_']  text-white font-mono -100 -200 `}>
